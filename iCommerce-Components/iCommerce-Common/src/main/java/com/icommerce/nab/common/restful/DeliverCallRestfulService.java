...
/**
 * Handling call Deliver-Service Restful APIs
 */
public class DeliverCallRestfulService extends BaseCallRestfulService {

    public DeliverCallRestfulService(RestTemplate restTemplate, Gson gson, CallRestfulRetryConfig retryConfig, String host) {
     ...
     * @return http request
     */
    public HttpEntity prepareRequestForDeliverOrders(String transactionId, List<OrderDTO> orderDTOS) {
